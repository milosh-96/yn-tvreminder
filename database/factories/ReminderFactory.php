...
$factory->define(App\Reminder::class, function (Faker $faker) {
    ...
    return [
            ...
            'date_range_start'=>$faker->dateTime($startDate = 'now',$endDate = '+2 years',$timezone = 'Europe/Belgrade'),
            ...
            'onetime_date'=>$faker->dateTime($startDate = 'now',$endDate = '+2 years',$timezone = 'Europe/Belgrade'),
